...
use crate::core::{
    CoreWarning, parse_date, parse_optional_date, parse_optional_id, resolve_or_generate_id,
};
use crate::exchange::{
...
impl ExchangeAccountHeader {
    ...
    fn build_from_export(import: &ExchangeAccountHeader) -> Result<Account, ExchangeError> {
        ...
        Ok(Account {
            ...
            terminated_date: parse_optional_date(&import.terminated_date)?, // Close date of the account.
            operations: Vec::new(),
